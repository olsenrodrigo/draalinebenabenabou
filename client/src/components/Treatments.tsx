  ...
  return (
    <section id="treatments" className="py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-block px-4 py-2 rounded-full mb-6" style={{ backgroundColor: "#E8F5F7" }}>
            <span className="text-sm font-medium" style={{ color: "#1E7B8C" }}>Procedimentos</span>
          </div>
          ...
          {treatments.map((item, index) => (
            ...
            >
              <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: "#E8F5F7" }}>
                <item.icon className="w-5 h-5" style={{ color: "#1E7B8C" }} />
              </div>
        ...
        <motion.div
          ...
          style={{ backgroundColor: "rgba(30, 123, 140, 0.08)" }}
        >
          <AlertCircle className="w-6 h-6 flex-shrink-0 mt-0.5" style={{ color: "#1E7B8C" }} />
