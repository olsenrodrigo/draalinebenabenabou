      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl max-w-3xl mx-auto" style={{ color: "#3C3C3C" }}>
            Atendimento particular no Instituto Emunah. Preencha o formulário ou entre em
            contato direto pelo WhatsApp — nossa equipe responde com agilidade.
          </p>
        </motion.div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border" style={{ borderColor: "rgba(91, 140, 155, 0.15)" }}>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: "#3C3C3C" }}>
                    contato@draalinebenabou.com.br
                  </p>
                </div>
              </div>
            </div>
