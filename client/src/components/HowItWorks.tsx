      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-block px-4 py-2 rounded-full mb-6" style={{ backgroundColor: "#E8F5F7" }}>
            <span className="text-sm font-medium" style={{ color: "#1E7B8C" }}>Conteúdo Educativo</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {topics.map((topic, index) => (
            ...
            >
              <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-4" style={{ backgroundColor: "#E8F5F7" }}>
                <BookOpen className="w-5 h-5" style={{ color: "#1E7B8C" }} />
              </div>
