 ...
 * Dra. Aline Benabou não está verificado lá, então o padrão sai de `sintetiza.ai`
...
const REMETENTE_PADRAO = "Site Dra. Aline Benabou <nao-responda@sintetiza.ai>";
const DESTINO_PADRAO = "contato@draalinebenabou.com.br";
